...
void handbook()
{
    while (true) {
        ...
        if (sb_loop == 2) {
            ...
            if (sb_part == 1) {
                cout << "*Student dress code is displayed*\n";
                cout << "Would you like to view the types of uniforms? (1 = yes, 2 = no): ";
                cin >> dc_type;

                if (dc_type == 1) {
                    cout << "\nTYPES OF UNIFORM:\n";
                    cout << "1. Type A uniform: Girls: Cream blouse, ID, Logo on blouse, orange checkered skirt, black shoes, white socks. \n";
                    cout << "                 White polo with logo, black pants, ID, black shoes, white socks."
                    cout << "2. Summer uniform: Summer uniform shirt, pants, rubber shoes, white/black socks, ID. \n";
                    cout << "3. PE uniform: PE uniform shirt, jogging pants, rubber shoes, ID. \n";
                    cout << "4. Casual clothing: Pants/bottoms below the knee, decent top, no open-toe footwear. \n";
                } else if (dc_type != 2) {
                    cout << "Invalid choice\n";
                }
            } else if (sb_part == 2) {
	...
	while (true){
        ...
        while (cmenu == 1) {
            ...
            if (canns == "A" or canns == "a") {
                cout << "This part of the code is beyond the capabilites of the group." << endl;
            }
        ...
        while (cmenu==2) {
            ...
            if (grade==7) {
                ...
                if (section == "Diamond" || section == "diamond") {
                    ...
                    cout << "https://drive.google.com/file/d/1Wck6cxdtlvy6TOqDJc4DdMCmvHUaBIaQ/view?usp=drive_link" << endl;
                ...
                if (section == "Ruby" || section == "ruby") {
                    ...
                    cout << "https://drive.google.com/file/d/1S7gCA3NrscjnyRoLhq-VmV2FFcPjA4n3/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                    cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Jade" || section == "jade") {
                    ...
                    cout << "https://drive.google.com/file/d/1inyfQ_oI8kyp3jZiZjJNe9bxyZtHOQAR/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Sapphire" || section == "sapphire") {
                    ...
                    cout << "https://drive.google.com/file/d/1KxqJzYcY19X0UVXMIrMoQYMYGRfd1LTo/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
            ...
            if (grade==8) {
                ...
                if (section == "Waling" || section == "waling") {
                    ...
                    cout << "https://drive.google.com/file/d/14R_h8pfmrTMlO2hQryZaGoIxyNd80Jjd/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Ilang" || section == "ilang") {
                    ...
                    cout << "https://drive.google.com/file/d/1z2Bondks0IH1PX4tCJpUYzL-nUJ9-Er0/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Adelfa" || section == "adelfa") {
                    ...
                    cout << "https://drive.google.com/file/d/17cnGCOcM_F8omjsoq_QngKPLFHZPJmkl/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Sampaguita" || section == "sampaguita") {
                    ...
                    cout << "https://drive.google.com/file/d/1Hql9_lokTULmOuQvX_KrvlBOVQ2Mys52/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
            ...
            if (grade==9) {
                ...
                if (section == "Argon" || section == "argon") {
                    ...
                    cout << "https://drive.google.com/file/d/1OQh0XpiY7ucTk3WcgUPDYhb69VsIW_cv/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Xenon" || section == "xenon") {
                    ...
                    cout << "https://drive.google.com/file/d/1hEcdHr9gqzN3nl2wvE9Vuw0fgwqoda6t/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Krypton" || section == "krypton") {
                    ...
                    cout << "https://drive.google.com/file/d/1FWWSy3Fw2gVZeSs5WmQJTJdKS_VmGyLs/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Neon" || section == "neon") {
                    ...
                    cout << "https://drive.google.com/file/d/1mr--DkJGDlE_uCjHx_x2_Tn9R6DY1-m7/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
            ...
            if (grade==10) {
                ...
                if (section == "Photon" || section == "photon") {
                    cout << "=== Photon's Class Schdule ===" << endl;
                    cout << "https://drive.google.com/file/d/1BjOqQxxc8mZ0d2jXQlrah4FRniPUolCM/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Muon" || section == "muon") {
                    ...
                    cout << "https://drive.google.com/file/d/1rOqCbry_E21ET-ZLwkSyNCXNIvwOfOgB/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Gluon" || section == "gluon") {
                    ...
                    cout << "https://drive.google.com/file/d/14QVjVSfb5VSgCvNwCAtWTiK4ogn0YRhK/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Electron" || section == "electron") {
                    ...
                    cout << "https://drive.google.com/file/d/1bMDWEIJsCrYlRcoVSHkD_LJJ9BxeCADi/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
            ...
            if (grade==11) {
                ...
                if (section == "Rigel" || section == "rigel") {
                    ...
                    cout << "https://drive.google.com/file/d/1k-oZEqq7ocKPQYa3nPxqWMVN_hbTZxfi/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Vega" || section == "vega") {
                    ...
                    cout << "https://drive.google.com/file/d/12AXhqETLjKrY8ajaueqfzAUnivqI3yO-/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Polaris" || section == "polaris") {
                    ...
                    cout << "https://drive.google.com/file/d/1JDn4lK3cUjAL18l3AYILG1wsgZ0-8g80/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Sirius" || section == "sirius") {
                    ...
                    cout << "https://drive.google.com/file/d/1dWK8VzaFVDOR7V3V4oDJgTyz3WjiwWkD/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
            ...
            if (grade==12) {
                ...
                if (section == "Banahaw" || section == "banahaw") {
                    ...
                    cout << "https://drive.google.com/file/d/1QgFw71SGQ4u1PcePG3L02-49DjdMjcm7/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Makiling" || section == "makiling") {
                    ...
                    cout << "https://drive.google.com/file/d/1N2mj6Mka7YWkAdjs3heQXzuTdc9jX9GU/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Batulao" || section == "batulao") {
                    ...
                    cout << "https://drive.google.com/file/d/1gfqmxROfWGvIyJfVSZxNZ-rqhQtSfwtb/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
                ...
                if (section == "Malarayat" || section == "malarayat") {
                    ...
                    cout << "https://drive.google.com/file/d/194mwcyuHEJlunfrBciB7JXwhzrvlXprt/view?usp=drive_link" << endl;
                    cout << "Press The 'A' Key To go back to Main Menu: ";
                    cin >> emp;
                    while (emp!="A" && emp != "a") {
                        cout << "Wrong Key, Try Again: ";
...
//hopefully this is the right file im editing and not one of the backups or the non functioning ones!!!
//also hopefully this code works and i didnt mess up the other functions hahahahahhhahaahahhahhahhahahhah
//whys it so 